...
def time_pulse_setup(uartGPS, gps_pulses_per_sec):
    ...
    if gps_pulses_per_sec == 20:
        uartGPS.write(b'\xB5\x62\x06\x31\x20\x00\x00\x01\x00\x00\x32\x00\x00\x00\x01\x00\x00\x00\x14\x00\x00\x00\x00\x00\x00\x00\x34\x33\x33\x33\x00\x00\x00\x00\x6F\x00\x00\x00\xDB\x30')    
    elif gps_pulses_per_sec == 10:
